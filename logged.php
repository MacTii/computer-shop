            ...
            <div class="site-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h2 class="text-black"><?php echo $_SESSION['first_name']." ". $_SESSION['last_name'];?></h2>
                            <p class="mb-4">
                            ...
                            <?php
                                if($_SESSION['client'] == true) {
                                    echo '<a href="transaction_history.php" class="buy-now btn btn-sm btn-primary">Transaction history</a>';
                                }
                            ?>
                            <a href="logout.php" class="buy-now btn btn-sm btn-primary">Logout</a>
                            </p>
                        </div>
                    </div>
                </div>
