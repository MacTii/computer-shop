...
if(isset($_SESSION['login_user'])) {
  ...
  $id_products = implode(" ", $_SESSION['id_array']);
  $query_transaction_history = "INSERT INTO historia (id_klient, id_produktow) VALUES ('$id', '$id_products')";

  if(!mysqli_query($conn, $query_transaction_history)) {
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><a href="shop_base.php" class="btn btn-sm btn-primary">Back to shop</a></p>
          </div>
        </div>
      </div>
    </div>
